...
static __sighandler_t saval;	/* For saving alarm() handler */
static __sighandler_t savquit;	/* and other signal handlers */
#ifdef SIGUSR1
static __sighandler_t savusr1;
#endif /* SIGUSR1 */
#ifdef SIGUSR2
static __sighandler_t savusr2;
#endif /* SIGUSR2 */
#ifdef SIGPIPE
static __sighandler_t savpipe;
#endif /* SIGPIPE */
#ifdef SIGDANGER
static __sighandler_t savdanger;
#endif /* SIGDANGER */

#ifndef NOJC
static __sighandler_t jchdlr;	/* For checking suspend handler */
#endif /* NOJC */
...
int cc_int;				/* Flag */
__sighandler_t occt;			/* For saving old SIGINT handler */
...
static __sighandler_t save_sigchld;	/* For catching SIGCHLD */
